...
public class ComDiferidaActivacionesKyhVO extends ValueObject{
	...
	public ComDiferidaActivacionesKyhVO() {}
	
	public ComDiferidaActivacionesKyhVO(Map<String, Object> dato) {
