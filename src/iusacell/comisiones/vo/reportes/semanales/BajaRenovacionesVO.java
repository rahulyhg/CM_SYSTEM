...
public class BajaRenovacionesVO extends ValueObject{
	...
	private String[] campos = {"REGION","PLAN_USO","DESC_LARGA_PLAN","CVE_CANAL","DESC_CANAL","CVE_CONTRATO",
			"CUENTA","NUM_TELEFONO","FECHA_VENTA","FECHA_BAJA","DIAS_DIFF","SUMA_MONTOS","POBKPNOMBNRE",
			"DES_DIVISION","EDODENOMBRE","ORIGEN_EQPO","MONTO_EQPO","ORIGEN_EMP"};
	...
	public BajaRenovacionesVO(Map<String, Object> dato) {
		...
		this.POBKPNOMBNRE = String.valueOf(dato.get("POBKPNOMBNRE"));
	...
	public String getPOBKPNOMBNRE() {
		return POBKPNOMBNRE;
	}
	public void setPOBKPNOMBNRE(String POBKPNOMBNRE) {
		this.POBKPNOMBNRE = POBKPNOMBNRE;
	}
