...
public class BajasActivacionesVO extends ValueObject{
	...
	private String[] campos = {"region","planUso","descLargaPlan","cveCanal","descCanal","cveContrato",
			"cuenta","numTelefono","fechaVenta","fechaBaja","diasDiff","sumaMontos","pobknombre","desDivision",
			"edodenombre","origenEqpo","montoEqpo","origenEmp"};
	...
	public BajasActivacionesVO(Map<String, Object> dato) {
		...
		this.pobknombre = String.valueOf(dato.get("POBKPNOMBRE"));
