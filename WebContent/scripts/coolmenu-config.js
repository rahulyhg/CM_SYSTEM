...
oCMenu.barwidth="1000" //The width of the background bar. Set this to "menu" if you want it to be the same width as the menu. (this will change to match the border if you have one) - Value: px || "%" || "menu"
...
oCMenu.pxbetween=50 //How much space you want between each of the top items. - Value: px || "%"
...
oCMenu.level[0].width=150 //The default width for each level[0] (top) items. You can override this on each item by spesifying the width when making the item. - Value: px || "%"
oCMenu.level[0].height=50 //The default height for each level[0] (top) items. You can override this on each item by spesifying the height when making the item. - Value: px || "%"
...
oCMenu.level[0].style="padding:2px; font-family:tahoma,arial,helvetica; font-size:10px; font-weight:bold" //The style for all level[0] (top) items. - Value: "style_settings"
...
// menu arrows
cmTopMenuImage='&nbsp;&nbsp;&nbsp;<img src="gifs/Darrow.gif">'
