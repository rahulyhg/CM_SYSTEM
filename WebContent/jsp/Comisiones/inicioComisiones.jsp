		...
		<div id="content">
			...
			<div id="menu">
				<form id="formCargar" class="form-horizontal" name="form" method="post" 
					action="<%=request.getContextPath() %>/cargaArchivo.do?go=carga" 
					role="form" >
					<input type="submit" class="btn btn-default cssButton btnMenu"
						value="Cargar Archivo" alt="Cargar Archivo" id="btnCargar" />
				</form>
				<form id="formConsultar" class="form-horizontal" name="form" method="post"
					action="<%=request.getContextPath() %>/consultaArchivo.do?go=consulta" 
					role="form" >
					<input type="submit" class="btn btn-default cssButton btnMenu"
						value="Consultar Archivo" alt="Consultar Archivo" id="btnConsultar"/>
				</form>
