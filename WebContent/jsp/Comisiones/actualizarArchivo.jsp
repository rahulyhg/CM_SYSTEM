...
<body>
	...
	<div id="content" class="container-fluid">
		<form onsubmit="return startStatusCheck();" class="form-horizontal"
			...
			<input id="idTipoArchivo" name="idTipoArchivo" type="hidden" value='<bean:write name="idTipoArchivo" />' />
			<input id="idArchivo" name="idArchivo" type="hidden" value='<bean:write name="idArchivo" />' />
			...
			<div class="form-group">
			  	<label for="descArchivoInput" class="control-label col-sm-2">Archivo Cargado:</label>
				<div class="col-sm-4">
					<input id="descArchivoInput" name="descArchivoInput" type="text" disabled 
						value='<bean:write name="descArchivo" />' class="form-control"/>						
			    </div>
				<div class="col-sm-6">
			...
			<div class="form-group">        
				<label for="descTipoArchivoInput" class="control-label col-sm-2">Tipo de Archivo Cargado:</label>
				<div class="col-sm-4">
					<input id="descTipoArchivoInput" name="descTipoArchivoInput" type="text" disabled 
						value='<bean:write name="descTipoArchivo" />' class="form-control"/>							
			    </div>
			...
			<div class="form-group">
				...
				<div class="col-sm-2">
					<input type="submit" name="btnActualizar" id="btnActualizar" 
						class="btn btn-default cssButton" style="display: none;"
						value="Actualizar" alt="Actualizar" />
					<input type="submit" name="btnActualizarG" id="btnActualizarG" 
						class="btn btn-default cssButton" style="display: none;"
						value="Actualizar" alt="Actualizar" />
			    </div>
				<div class="col-sm-2">
